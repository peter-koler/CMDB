...
from scripts.apply_cache_default_alerts import POLICIES, _render_alerts, _upsert_alerts
...
def _parse_template_meta(content: str, fallback_app: str) -> tuple[str, str, str]:
    ...
    category = (category_match.group(1).strip().lower() if category_match else "cache") or "cache"
...
def main() -> int:
    ...
    with flask_app.app_context():
        ...
        template_service.save_category("缓存", "cache", "database")
