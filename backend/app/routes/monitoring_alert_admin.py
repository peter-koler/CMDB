...
from app.routes.monitoring_target import require_any_permission
from app.services.monitoring_target_helpers import _json_dump, _json_load, _now_naive_utc


monitoring_alert_admin_bp = Blueprint(
    "monitoring_alert_admin", __name__, url_prefix="/api/v1/monitoring"
)
...
def _notice_rule_from_model(row: NoticeRule) -> dict:
    ...
    return {
        ...
        "receiver_id": row.receiver_channel_id,
...
@monitoring_alert_admin_bp.route("/alert-integrations", methods=["GET"])
@jwt_required()
...
@monitoring_alert_admin_bp.route("/alert-integrations", methods=["POST"])
@jwt_required()
...
@monitoring_alert_admin_bp.route("/alert-integrations/<integration_id>", methods=["PUT"])
@jwt_required()
...
@monitoring_alert_admin_bp.route("/alert-integrations/<integration_id>", methods=["DELETE"])
@jwt_required()
...
@monitoring_alert_admin_bp.route("/alert-integrations/<integration_id>/toggle", methods=["PATCH"])
@jwt_required()
@require_any_permission("monitoring:alert:integration", "monitoring:alert:integration:edit")
...
@monitoring_alert_admin_bp.route("/alert-integrations/<integration_id>/test", methods=["POST"])
@jwt_required()
...
@monitoring_alert_admin_bp.route("/alert-groups", methods=["GET"])
@jwt_required()
...
@monitoring_alert_admin_bp.route("/alert-groups", methods=["POST"])
@jwt_required()
...
@monitoring_alert_admin_bp.route("/alert-groups/<group_id>", methods=["PUT"])
@jwt_required()
...
@monitoring_alert_admin_bp.route("/alert-groups/<group_id>", methods=["DELETE"])
@jwt_required()
...
@monitoring_alert_admin_bp.route("/alert-groups/<group_id>/enabled", methods=["PATCH"])
@jwt_required()
@require_any_permission("monitoring:alert:group", "monitoring:alert:group:edit")
...
@monitoring_alert_admin_bp.route("/alert-inhibits", methods=["GET"])
@jwt_required()
...
@monitoring_alert_admin_bp.route("/alert-inhibits", methods=["POST"])
@jwt_required()
...
@monitoring_alert_admin_bp.route("/alert-inhibits/<inhibit_id>", methods=["PUT"])
@jwt_required()
...
@monitoring_alert_admin_bp.route("/alert-inhibits/<inhibit_id>", methods=["DELETE"])
@jwt_required()
...
@monitoring_alert_admin_bp.route("/alert-inhibits/<inhibit_id>/enabled", methods=["PATCH"])
@jwt_required()
@require_any_permission("monitoring:alert:inhibit", "monitoring:alert:inhibit:edit")
...
@monitoring_alert_admin_bp.route("/alert-silences", methods=["GET"])
@jwt_required()
...
@monitoring_alert_admin_bp.route("/alert-silences", methods=["POST"])
@jwt_required()
...
@monitoring_alert_admin_bp.route("/alert-silences/<silence_id>", methods=["PUT"])
@jwt_required()
...
@monitoring_alert_admin_bp.route("/alert-silences/<silence_id>", methods=["DELETE"])
@jwt_required()
...
@monitoring_alert_admin_bp.route("/alert-silences/<silence_id>/enabled", methods=["PATCH"])
@jwt_required()
@require_any_permission("monitoring:alert:silence", "monitoring:alert:silence:edit")
...
@monitoring_alert_admin_bp.route("/alert-notices", methods=["GET"])
@jwt_required()
...
@monitoring_alert_admin_bp.route("/alert-notices", methods=["POST"])
@jwt_required()
...
@monitoring_alert_admin_bp.route("/alert-notices/<notice_id>", methods=["PUT"])
@jwt_required()
...
@monitoring_alert_admin_bp.route("/alert-notices/<notice_id>", methods=["DELETE"])
@jwt_required()
...
@monitoring_alert_admin_bp.route("/alert-notices/<notice_id>/test", methods=["POST"])
@jwt_required()
...
@monitoring_alert_admin_bp.route("/notice-receivers", methods=["GET"])
@jwt_required()
@require_any_permission("monitoring:alert:notice", "monitoring:alert:notice:view")
...
@monitoring_alert_admin_bp.route("/notice-receivers/all", methods=["GET"])
@jwt_required()
@require_any_permission("monitoring:alert:notice", "monitoring:alert:notice:view")
...
@monitoring_alert_admin_bp.route("/notice-receivers/<receiver_id>", methods=["GET"])
@jwt_required()
@require_any_permission("monitoring:alert:notice", "monitoring:alert:notice:view")
...
@monitoring_alert_admin_bp.route("/notice-receivers", methods=["POST"])
@jwt_required()
@require_any_permission("monitoring:alert:notice", "monitoring:alert:notice:create")
...
@monitoring_alert_admin_bp.route("/notice-receivers/<receiver_id>", methods=["PUT"])
@jwt_required()
@require_any_permission("monitoring:alert:notice", "monitoring:alert:notice:edit")
...
@monitoring_alert_admin_bp.route("/notice-receivers/<receiver_id>", methods=["DELETE"])
@jwt_required()
@require_any_permission("monitoring:alert:notice", "monitoring:alert:notice:delete")
...
@monitoring_alert_admin_bp.route("/notice-receivers/<receiver_id>/test", methods=["POST"])
@jwt_required()
@require_any_permission("monitoring:alert:notice", "monitoring:alert:notice:test")
