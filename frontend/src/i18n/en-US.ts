export default {
  ...
  menu: {
    ...
    monitoringBulletin: 'Monitoring Bulletin',
    monitoringAlert: 'Alert Management',
    monitoringAlertCenter: 'Alert Center',
    monitoringAlertCurrent: 'Current Alerts',
    monitoringAlertHistory: 'Alert History',
    monitoringAlertRule: 'Alert Rules',
    monitoringAlertIntegration: 'Alert Integrations',
    monitoringAlertGroup: 'Alert Groups',
